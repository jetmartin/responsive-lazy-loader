 ...
 */
//$("*[data-src]").responsivelazyloader();
// Init lazyloder after ajax events.
//$("body").on({ ajaxStop : function(){ $("*[data-src]").responsivelazyloader(); }});

/**
 *  chain functions exemple
 */
$("*[data-src]").responsivelazyloader().attr('data-test', 'TEST');

/**
 *  Use callbacks & chain functions example
 */
$("*[data-src]").responsivelazyloader({
